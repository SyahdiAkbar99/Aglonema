...
<section class="banner bgwhite p-t-40 p-b-40">
    <div class="container">
        <!-- Product -->
        <div class="row p-3">
            <?php foreach ($data_rawat as $datrwt) : ?>
                <?php $no = 1; ?>
                <?php if ($datrwt['urutan'] % 2 == 1) : ?>
                                        ...
                                        <div class="row d-flex flex-row">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="card text-center" style="border: none;">
                                                    <div class="card-body">
                                                        <img src="<?= base_url('assets/admin/img/data/admin/perawatan/') . $datrwt['image']; ?>" class="img-fluid img-thumbnail text-center" style="width: 10rem;" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-7 bg-light">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <p class="text-center"><?= $datrwt['deskripsi']; ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>

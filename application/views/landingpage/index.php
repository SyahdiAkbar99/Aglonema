                ...
                <div class="row about-container">
                    ...
                    <div class="col-lg-6 content order-lg-1 order-2">
                        ...
                        <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
                            <div class="icon">
                                <img src="<?= base_url('assets/img/adelia.jpg') ?>" alt="Adelia" class="img-thumbnail">
                            </div>
                            <h4 class="title">Adelia</h4>
                            <p class="description">Aglonema Adelia adalah tanaman hybird dengan bentuk daun oval seperti mangkok menjulang ke atas</p>
                        </div>

                        <div class="icon-box" data-aos="fade-up" data-aos-delay="200">
                            <div class="icon">
                                <img src="<?= base_url('assets/img/angela.jpg') ?>" alt="Adelia" class="img-thumbnail">
                            </div>
                            <h4 class="title">Angela</h4>
                            <p class="description">Aglonema Angela adalah tanaman hybird dengan bentuk daun oval seperti mangkok menjulang ke atas</p>
                        </div>

                        <div class="icon-box" data-aos="fade-up" data-aos-delay="300">
                            <div class="icon">
                                <img src="<?= base_url('assets/img/ariana.jpg') ?>" alt="Adelia" class="img-thumbnail">
                            </div>
                            <h4 class="title">Ariana</h4>
                            <p class="description">Aglonema Angela adalah tanaman hybird dengan bentuk daun oval seperti mangkok menjulang ke atas</p>
                        </div>

...
<head>
    ...
    <!-- summernote -->
    <link rel="stylesheet" href="<?= base_url('assets/admin/css/summernote-bs4.min.css') ?>">
    <!-- Datatables -->
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="<?= base_url('assets/admin/img/favicon.png') ?>" alt="AdminLTELogo" height="60" width="60">
        </div>